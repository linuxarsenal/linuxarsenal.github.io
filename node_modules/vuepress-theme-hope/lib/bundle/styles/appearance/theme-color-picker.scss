...
// FIXME: https://github.com/stylelint-scss/stylelint-scss/issues/1212
    ...
    @if meta.type-of($color) == color {
      ...
      @if $light-color and $dark-color {
        @if $light-color == $dark-color {
          :root.theme-#{$index} {
            --vp-c-accent: #{color.change($light-color, $lightness: 35%, $alpha: 1)};
            --vp-c-accent-bg: #{color.change($light-color, $lightness: 45%, $alpha: 1)};
            --vp-c-accent-hover: #{color.change($light-color, $lightness: 50%, $alpha: 1)};
            --vp-c-accent-soft: #{color.change(
                $light-color,
                $lightness: 40%,
                $saturation: 80%,
          ...
          [data-theme="dark"].theme-#{$index} {
            --vp-c-accent: #{color.change($light-color, $lightness: 55%, $alpha: 1)};
            --vp-c-accent-bg: #{color.change($light-color, $lightness: 47.5%, $alpha: 1)};
            --vp-c-accent-hover: #{color.change($light-color, $lightness: 45%, $alpha: 1)};
          }
        } @else {
          :root.theme-#{$index} {
            --vp-c-accent: #{color.change($light-color, $lightness: 35%, $alpha: 1)};
          ...
          [data-theme="dark"].theme-#{$index} {
            --vp-c-accent: #{color.change($dark-color, $lightness: 55%, $alpha: 1)};
            --vp-c-accent-bg: #{color.change($dark-color, $lightness: 47.5%, $alpha: 1)};
            --vp-c-accent-hover: #{color.change($dark-color, $lightness: 45%, $alpha: 1)};
          }
        }
      }
    }
