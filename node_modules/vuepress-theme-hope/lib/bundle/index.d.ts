...
import { h as Author, k as AuthorInfo, l as AutoLinkOptions, N as NavItemOptions, i as ThemeBasePageFrontmatter, m as SidebarOptions, T as TocSlotData, S as SidebarItemsSlotData, j as PageInfoProps } from './slots-CjH6wxTg.js';
export { A as ArticleCoverSlotData, c as ArticleExcerptSlotData, b as ArticleInfoSlotData, a as ArticleTitleSlotData, n as AuthorName, B as BloggerInfoSlotData, e as HeroBackgroundSlotData, H as HeroInfoSlotData, d as HeroLogoSlotData, f as PortfolioAvatarSlotData, g as PortfolioBackgroundSlotData, P as PortfolioInfoSlotData, o as PortfolioMedia, p as SidebarArrayOptions, q as SidebarGroupItem, r as SidebarGroupOptions, s as SidebarItem, t as SidebarItemOptions, u as SidebarLinkItem, v as SidebarLinkOptions, w as SidebarObjectOptions, x as SidebarStructureOptions, y as Style, z as ThemePortfolioFrontmatter } from './slots-CjH6wxTg.js';
import { A as AppearanceLocaleData, b as AppearanceConfig } from './NotFound-DJHLkgjA.js';
export { c as AppearanceOptions, D as DarkModeOptions, d as DeprecatedAppearanceOptions, _ as Layout, a as NotFound, O as OutlookLocaleData, u as useDarkMode } from './NotFound-DJHLkgjA.js';
import { ThemeDataRef, ThemeLocaleDataRef } from '@vuepress/plugin-theme-data/client';
import { ClientData } from 'vuepress/client';
import { a as BlogLocaleConfig, B as BlogLocaleData, b as PaginationLocaleData, c as BlogLocaleOptions, P as PageInfoType, d as ThemeHomePageFrontmatter } from './blogHome-CcWLfYXz.js';
export { A as ArticleInfoData, D as DeprecatedBlogLocaleData, e as PageInfoData, f as PageType, g as ThemeBlogHomePageFrontmatter, T as ThemeBlogHomeProjectOptions } from './blogHome-CcWLfYXz.js';
...
type LocaleDataToOption<LocaleData> = {
