...
declare const resolveInclude: (content: string, options: Required<MarkdownItIncludeOptions>, {
  cwd,
  includedFiles
}: IncludeInfo) => string;
declare const include: PluginWithOptions<MarkdownItIncludeOptions>;
//#endregion
export { IncludeEnv, MarkdownItIncludeOptions, handleInclude, include, resolveInclude };
