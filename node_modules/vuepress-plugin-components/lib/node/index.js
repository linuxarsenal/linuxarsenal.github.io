...
`)},de=(e,n=!0)=>a=>(n&&re(e),a.env.isDebug&&l.info("Options:",e),x(a,{id:"hope",defaultConfig:d("vuepress-shared/styles/config.scss",import.meta)}),{name:h,define:ce(e),extendsBundlerOptions:t=>{e.components?.includes("ArtPlayer")&&A(t,a,"artplayer"),e.components?.includes("VidStack")&&T(t,a,/^media-/),z(t,a,["@vuepress/helper","vuepress-shared"])},clientConfigFile:()=>ue(a,e)});export{k as AVAILABLE_SERVICES,r as SHARE_CONFIG,de as componentsPlugin,g as pdfLocaleInfo,P as siteInfoLocaleInfo,y as vidstackLocaleInfo};
